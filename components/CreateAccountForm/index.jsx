...
const CreateAccountForm = ({
  ...
  console.log(countryOnUrl, "country");
  ...
  return (
    <>
      <Stack sx={styles.topContainer} spacing={1}>
        <Box>
          <Image
            src={countryOnUrl === "1" ? "/iPay-logo.svg" : "/elipaLogo.png"}
            alt="iPay Logo"
            width={78}
            height={39}
          />
      ...
      >
        ...
        <CreateAccountFormDiv topLabel="Tell us about your business">
          <Stack direction="column" spacing={2}>
            ...
            <CheckBoxes
              formFields={
                (formData.countryOfOperation === "3" && togoIpayProducts) ||
                (formData.countryOfOperation === "1" && kenyaIpayProducts) ||
                (formData.countryOfOperation === "4" && ugandaIpayProducts) ||
                (formData.countryOfOperation === "2" && tanzaniaIpayProducts) ||
                kenyaIpayProducts
              }
...
CreateAccountForm.propTypes = {
  ...
  countryOnUrl: PropTypes.string.isRequired,
};
