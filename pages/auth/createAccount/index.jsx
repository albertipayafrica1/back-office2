...
export const getServerSideProps = async (context) => {
  ...
  if (givenCountryCode === undefined && givenrc === undefined) {
    return {
      redirect: {
        permanent: false,
        destination: `/auth/createAccount?country=KE&rc=RC000000`,
      },
    };
  }
  if (
    ...
    return {
      redirect: {
        permanent: false,
        destination: `/auth/createAccount?country=KE&rc=${givenrc}`,
      },
    };
  }
  if (
  ...
  if (givenCountryCode !== undefined && givenrc === undefined) {
    return {
      redirect: {
        permanent: false,
        destination: `/auth/createAccount?country=${givenCountryCode}&rc=RC000000`,
      },
    };
  }
